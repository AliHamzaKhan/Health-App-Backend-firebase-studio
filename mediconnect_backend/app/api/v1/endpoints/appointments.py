...
@router.get("/patients/me/appointments", response_model=List[Appointment])
...
@router.post("/patients/me/appointments", response_model=Appointment, status_code=status.HTTP_201_CREATED)
...
@router.get("/patients/me/appointments/{appointment_id}", response_model=Appointment)
...
@router.patch("/patients/me/appointments/{appointment_id}", response_model=Appointment)
...
@router.get("/doctors/me/appointments", response_model=List[Appointment])
...
@router.get("/doctors/me/appointments/{appointment_id}", response_model=Appointment)
...
@router.patch("/doctors/me/appointments/{appointment_id}", response_model=Appointment)
...
@router.post("/doctors/me/appointments/{appointment_id}/consultation", response_model=Appointment)
...
@router.post("/doctors/me/appointments/follow-up", response_model=Appointment, status_code=status.HTTP_201_CREATED)
